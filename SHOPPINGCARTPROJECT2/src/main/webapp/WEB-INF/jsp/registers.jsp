	...
	<div>
		...
		<section id="content">
			...
			<form:form action="${addAction}" commandName="userDetails"
				method="post">
				<!-- <h1>Registration</h1> -->
				<input path="name" type="text" placeholder="Name" id="username" name="username" 
						pattern=".{5,10}" required="true" title="minimum length for username is 5"/>
				<%-- <div>
				...
				<p class="message">Already a user? <a href="login">Log in</a></p>
				<!-- <div>
					<input type="submit" value="Register" /> <a href="#">Already a user?</a> <a href="login">Sign In</a>
				</div> -->
